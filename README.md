...
This article details the benchmarking results for the vLLM inference engine using the `Qwen2-7B-Instruct`, `Qwen2.5-32B` and `Qwen2-72B` models, tested on a system equipped with NVIDIA A100 80GB GPU. These results highlight vLLM’s ability to efficiently utilize GPU resources using PagedAttention and continuous batching techniques. A key focus of the benchmarking is to evaluate how generation throughput performance correlates with the configured KV cache memory capacity. To explore this, the `gpu-memory-utilization` setting was varied to determine whether the relationship between memory allocation and throughput is linear. The tests reveal how performance dynamically shifts between being compute-bound (limited by GPU processing power) and memory-bound (constrained by VRAM/GRAM capacity).
...
============ Serving Benchmark Result ============
Successful requests:                     10        
Benchmark duration (s):                  42.85     
Total input tokens:                      10239     
Total generated tokens:                  10240     
Request throughput (req/s):              0.23      
Output token throughput (tok/s):         238.95    
Total Token throughput (tok/s):          477.89    
---------------Time to First Token----------------
Mean TTFT (ms):                          29715.45  
Median TTFT (ms):                        29716.24  
P99 TTFT (ms):                           29727.46  
-----Time per Output Token (excl. 1st token)------
Mean TPOT (ms):                          9.62      
...
(APIServer pid=136) INFO 09-09 01:40:49 [loggers.py:123] Engine 000: Avg prompt throughput: 0.0 tokens/s, Avg generation throughput: 22.3 tokens/s, Running: 0 reqs, Waiting: 0 reqs, GPU KV cache usage: 0.0%, Prefix cache hit rate: 51.2%
(APIServer pid=136) INFO 09-09 01:40:59 [loggers.py:123] Engine 000: Avg prompt throughput: 1023.9 tokens/s, Avg generation throughput: 875.7 tokens/s, Running: 6 reqs, Waiting: 0 reqs, GPU KV cache usage: 2.3%, Prefix cache hit rate: 55.4%
(APIServer pid=136) INFO 09-09 01:41:09 [loggers.py:123] Engine 000: Avg prompt throughput: 0.0 tokens/s, Avg generation throughput: 148.3 tokens/s, Running: 0 reqs, Waiting: 0 reqs, GPU KV cache usage: 0.0%, Prefix cache hit rate: 55.4%
```
...
### <a name="toc_9"></a>✍️ Test 7: 2 GPU pods host 72B model in the same node (Available KV cache memory in each GPU: 6.77 GiB)
